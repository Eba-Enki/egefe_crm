    ...
    if ($fazlalar) {
        ...
        foreach ($fazlalar as $i => $it) {
            ...
            $lotStmt->execute([
                ...
                $it['lot_no'], $tarih, $it['urun_adi'], $it['lot_marka'], $it['lot_model'], $it['lot_seri_no'], $it['lot_notlar'], $it['lot_kategori_id'], $it['lot_parametreler'],
