  ...
  users.forEach(function(u){
    ...
    html += '<div class="sistem-user-row">'
      ...
      + '<div class="action-row">'
        + '<button class="btn-icon" onclick="goSistemUserForm(\''+u.id+'\')"><i class="ti ti-edit" style="color:var(--accent)"></i></button>'
        + (!isSelf?'<button class="btn-icon" style="color:var(--red)" onclick="silSistemUser(\''+u.id+'\')"><i class="ti ti-trash"></i></button>':'')
      + '</div>'
    + '</div>';
  });
  html += '</div>';
