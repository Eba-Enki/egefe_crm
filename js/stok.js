  ...
  el.innerHTML=kats.map(function(k,i){
    ...
    if(_hamKatEditIdx===i){
      return '<div style="background:var(--bg3);border:1px solid var(--accent);border-radius:6px;padding:12px;margin-bottom:6px">'
        +'<div style="font-size:11px;color:var(--accent);font-weight:600;margin-bottom:10px">Düzenleniyor: '+stokEsc(k.ad)+'</div>'
        +'<div style="display:grid;grid-template-columns:1fr 90px 90px 70px;gap:8px;align-items:end;margin-bottom:10px">'
          +'<div class="field" style="margin:0"><label style="font-size:10px">Kategori Adı *</label><input type="text" id="kat-edit-ad" value="'+stokEsc(k.ad)+'"></div>'
          ...
          +'<div class="field" style="margin:0"><label style="font-size:10px">Kesim Böleni</label><input type="number" id="kat-edit-kb" value="'+k.kesimBoleni+'" min="1" style="text-align:center"></div>'
          +'<div class="field" style="margin:0"><label style="font-size:10px">Fire (%)</label><input type="number" id="kat-edit-fp" value="'+k.firePct+'" min="0" max="50" style="text-align:center"></div>'
        +'</div>'
    ...
    return '<div style="padding:10px 12px;background:var(--bg3);border:1px solid var(--border);border-radius:6px;margin-bottom:6px">'
      +'<div style="display:flex;align-items:center;gap:10px">'
        +'<div style="display:grid;grid-template-columns:1fr 90px 90px 70px;gap:8px;flex:1;align-items:center">'
          +'<div><div style="font-size:10px;color:var(--text3);margin-bottom:3px">Kategori Adı</div><div style="font-size:13px;font-weight:500;color:var(--text)">'+stokEsc(k.ad)+'</div></div>'
          ...
          +'<div style="text-align:center"><div style="font-size:10px;color:var(--text3);margin-bottom:3px">Kesim Böleni</div><div style="font-size:13px;font-family:var(--font-mono);color:var(--text)">'+k.kesimBoleni+'</div></div>'
          +'<div style="text-align:center"><div style="font-size:10px;color:var(--text3);margin-bottom:3px">Fire (%)</div><div style="font-size:13px;font-family:var(--font-mono);color:var(--text)">'+k.firePct+'</div></div>'
        +'</div>'
        +'<div style="display:flex;flex-direction:column;align-items:flex-end;gap:6px;flex-shrink:0">'
          +'<div style="font-size:11px;font-family:var(--font-mono);color:var(--teal);font-weight:600;white-space:nowrap">→ '+sps+' strip/sh</div>'
