...
CREATE TABLE service_records (
  ...
  durum               ENUM('Yeni Gelen','S.F. Bekleniyor','Onay Bekleniyor','Onaylandı','Kargoya Verildi','Tamamlandı','Reddedildi','İade Edildi') NOT NULL DEFAULT 'Yeni Gelen',
...
CREATE TABLE quotes (
  ...
  durum               ENUM('Taslak','Açık Teklif','Onay Bekleniyor','Onaylandı','Kabul Edildi','Siparişe Aktarıldı','Gönderildi','Reddedildi','İptal Edildi','Tamamlandı') NOT NULL DEFAULT 'Taslak',
...
CREATE TABLE raw_stock_lots (
  ...
  sheet_giren         INT NOT NULL DEFAULT 0,
